...
// _Printfxy(0,0,tmp,0);
//  DispOneFiled(1,0,"户名:",TEST_NAME);
// _Skip(1);
//  DispOneFiled(2,0,"户名:",TEST_NAME);
// _Skip(-2);
//  _Replace(TEST_NAME,"张三");
//  DispOneFiled(3,0,"户名:",TEST_NAME);
//  _Del();
//  _Pack();
//    DispOneFiled(4,0,"户名:",TEST_NAME);
//_Go(1);



//if (_Bof())  _Printfxy(0,5*16,"第一条记录",0);
//_Go(_Reccount());
//if (_Eof())  _Printfxy(0,6*16,"最后的记录",0);
//_App();
